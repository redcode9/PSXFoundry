...
#
# The standard frame, just a simple thin frame where the cover is pasted in the middle
#
i0 = bytes([
...
#
# A special frame for NTSC-U PSN games.
# The left side of the frame is much thicker than the top/right/bottom sides
# and has the text "Playstation" running from the bottom to the top.
# Top left corner is the PS logo.
# The cover used should have the logo on the left cropped and be resized to
# 60x67 pixels
#
i0l = bytes([
...
])
...
def get_icon0_from_game(game_id, game, cue, tmpfile, selected_file=None, psn_frame_size=None, psp_ntsc_u_frame=False):
    if selected_file:
    ...
    if psp_ntsc_u_frame:
        im0 = Image.open(io.BytesIO(i0l)).convert('RGBA')
        i = i.resize((60,67), Image.Resampling.LANCZOS)
        Image.Image.paste(im0, i, box=(14,7))
        return im0
    if psn_frame_size:
